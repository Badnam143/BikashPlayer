...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " ARU MUSIC ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/Badnam143/BikashPlayer",)
...
START_IMG_URL = getenv("START_IMG_URL", f"https://telegra.ph/file/2613fbbf52f7cbfabc11f.jpg")
